...
public class TelephoneValidator implements Validator {
    //private static String regExpPatternString = "^(\\+[0-9]{1,4})?(\\([0-9]{1,4}\\))?[0-9]{5,12}(\\.[0-9]{1,5})?$";
	//private static String regExpPatternString = "^([0-9]{1,4})+([-][0-9]{1,4})+$";
	private static String regExpPatternString = "^([0-9]{5,12})+$";
